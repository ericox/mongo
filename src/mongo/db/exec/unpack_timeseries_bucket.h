 ...
 * It fetches a bucket from it's child as an owned BSONObj and uses the BucketUnpacker to materialze
 * time-series measurements until the time-series bucket collection is exhausted.
 */
